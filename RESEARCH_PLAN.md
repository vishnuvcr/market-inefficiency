...
**Status: ~50% — Phase 3.1–3.5 deterministic diagnostic scaffolds implemented; real-data evidence remains gated on validated immutable snapshots.**
...
- 3.6 **Descriptive regime segmentation — next.**
